...
get_go_hmap = function(matrix, names, path_names_go, path_slot, cell_types, reorder=FALSE) {
    ...
    # Find the index of each gene name in the reordered matrix
    ...
    h = Heatmap(as.matrix(matrix[, cell_types]),
                right_annotation = ha, 
